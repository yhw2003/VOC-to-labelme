...
def parse_args():
    ...
    parser.add_argument('--input-xml', help='the path of raw label',
                        default=r'.\\Annotations')
    parser.add_argument('--input-jpg', help='the path of picture',
                        default=r'.\JPEGImages')
    parser.add_argument('--output', help='the path of new label',
                        default=r'.\label_json')
